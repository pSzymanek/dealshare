...
const sections = [
  {
    title: "Kim jesteśmy",
    text: "dealshare to nowoczesna platforma B2B tworzona z myślą o przedsiębiorcach, którzy chcą szybciej docierać do sensownych ofert i kontaktów."
  },
  {
    title: "Co robimy",
...
export default function AboutPage() {
  return (
    <main>
      ...
      <CTASection title="Chcesz dołączyć jako partner albo szukasz ofert dla firmy?" buttonLabel="Przejdź do kontaktu" buttonHref="/kontakt" />
    </main>
  );
}
