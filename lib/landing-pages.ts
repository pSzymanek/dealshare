...
export const landingPages: Record<string, LandingPageConfig> = {
  "umowy-na-energie": {
    ...
    formText: "Zostaw kontakt i podstawowe informacje. Fakturę lub umowę możesz dosłać w kolejnym kroku.",
    seo: {
  ...
  "sankcja-kredytu-darmowego": {
    ...
    formText: "Zostaw kontakt i podstawowe informacje o kredycie. Wrócimy z pytaniami albo prośbą o dokumenty do analizy.",
    seo: {
