...
const items = [{ href: "/admin/sprawy", label: "Sprawy", icon: BriefcaseBusiness }, { href: "/admin/oferenci", label: "Oferenci", icon: Handshake }, { href: "/admin/oferty", label: "Oferty", icon: ListChecks }, { href: "/admin/uzytkownicy", label: "Użytkownicy", icon: Users }];
