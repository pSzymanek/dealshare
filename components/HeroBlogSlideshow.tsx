...
export function HeroBlogSlideshow({ posts }: HeroBlogSlideshowProps) {
  ...
  return (
    <section className="relative overflow-hidden rounded-lg border border-white/18 bg-white/8 p-4 shadow-glow backdrop-blur sm:p-5" aria-label="Wybrane artykuły z bloga">
      <div className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-cyan/14 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-20 left-10 h-52 w-52 rounded-full bg-electric/20 blur-3xl" />
      ...
      <div className="relative z-10 min-h-[390px] overflow-hidden rounded-md border border-white/14 bg-navy/34 sm:min-h-[430px]">
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                <div className="mb-4 inline-flex rounded border border-white/18 bg-white/12 px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-cyan backdrop-blur">
                  {post.category}
                </div>
